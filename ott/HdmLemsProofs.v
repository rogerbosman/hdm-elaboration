...
(forall DSch1 dskA1 n1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
...
(forall DSch2 DSch1 dskA1 n1,
  dskA1 `notin` fv_dska_DSch DSch2 ->
  dskA1 `notin` fv_dska_DSch DSch1 ->
...
Lemma fv_dska_DTy_close_DTy_wrt_DTy_rec_mutual :
(forall DTy1 dskA1 n1,
  fv_dska_DTy (close_DTy_wrt_DTy_rec n1 dskA1 DTy1) [=] remove dskA1 (fv_dska_DTy DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
...
Lemma fv_dska_DTy_close_DTy_wrt_DTy_rec :
forall DTy1 dskA1 n1,
  fv_dska_DTy (close_DTy_wrt_DTy_rec n1 dskA1 DTy1) [=] remove dskA1 (fv_dska_DTy DTy1).
Proof.
pose proof fv_dska_DTy_close_DTy_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_close_DTy_wrt_DTy_rec : lngen.
#[export] Hint Rewrite fv_dska_DTy_close_DTy_wrt_DTy_rec using solve [auto] : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_dska_DSch_close_DSch_wrt_DTy_rec_mutual :
(forall DSch1 dskA1 n1,
  fv_dska_DSch (close_DSch_wrt_DTy_rec n1 dskA1 DSch1) [=] remove dskA1 (fv_dska_DSch DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_close_DSch_wrt_DTy_rec :
forall DSch1 dskA1 n1,
  fv_dska_DSch (close_DSch_wrt_DTy_rec n1 dskA1 DSch1) [=] remove dskA1 (fv_dska_DSch DSch1).
Proof.
pose proof fv_dska_DSch_close_DSch_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_close_DSch_wrt_DTy_rec : lngen.
#[export] Hint Rewrite fv_dska_DSch_close_DSch_wrt_DTy_rec using solve [auto] : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Ty_close_Ty_wrt_Ty_rec_mutual :
(forall Ty1 skA1 n1,
  fv_ska_Ty (close_Ty_wrt_Ty_rec n1 skA1 Ty1) [=] remove skA1 (fv_ska_Ty Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_close_Ty_wrt_Ty_rec :
forall Ty1 skA1 n1,
  fv_ska_Ty (close_Ty_wrt_Ty_rec n1 skA1 Ty1) [=] remove skA1 (fv_ska_Ty Ty1).
Proof.
pose proof fv_ska_Ty_close_Ty_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_close_Ty_wrt_Ty_rec : lngen.
#[export] Hint Rewrite fv_ska_Ty_close_Ty_wrt_Ty_rec using solve [auto] : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Sch_close_Sch_wrt_Ty_rec_mutual :
(forall Sch1 skA1 n1,
  fv_ska_Sch (close_Sch_wrt_Ty_rec n1 skA1 Sch1) [=] remove skA1 (fv_ska_Sch Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_close_Sch_wrt_Ty_rec :
forall Sch1 skA1 n1,
  fv_ska_Sch (close_Sch_wrt_Ty_rec n1 skA1 Sch1) [=] remove skA1 (fv_ska_Sch Sch1).
Proof.
pose proof fv_ska_Sch_close_Sch_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_close_Sch_wrt_Ty_rec : lngen.
#[export] Hint Rewrite fv_ska_Sch_close_Sch_wrt_Ty_rec using solve [auto] : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_e_x_e_close_e_wrt_e_rec_mutual :
(forall e1 x1 n1,
  fv_e_x_e (close_e_wrt_e_rec n1 x1 e1) [=] remove x1 (fv_e_x_e e1)).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_close_e_wrt_e_rec :
forall e1 x1 n1,
  fv_e_x_e (close_e_wrt_e_rec n1 x1 e1) [=] remove x1 (fv_e_x_e e1).
Proof.
pose proof fv_e_x_e_close_e_wrt_e_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_close_e_wrt_e_rec : lngen.
#[export] Hint Rewrite fv_e_x_e_close_e_wrt_e_rec using solve [auto] : lngen.

(* end hide *)

Lemma fv_dska_DTy_close_DTy_wrt_DTy :
forall DTy1 dskA1,
  fv_dska_DTy (close_DTy_wrt_DTy dskA1 DTy1) [=] remove dskA1 (fv_dska_DTy DTy1).
Proof.
unfold close_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DTy_close_DTy_wrt_DTy : lngen.
#[export] Hint Rewrite fv_dska_DTy_close_DTy_wrt_DTy using solve [auto] : lngen.

Lemma fv_dska_DSch_close_DSch_wrt_DTy :
forall DSch1 dskA1,
  fv_dska_DSch (close_DSch_wrt_DTy dskA1 DSch1) [=] remove dskA1 (fv_dska_DSch DSch1).
Proof.
unfold close_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DSch_close_DSch_wrt_DTy : lngen.
#[export] Hint Rewrite fv_dska_DSch_close_DSch_wrt_DTy using solve [auto] : lngen.

Lemma fv_ska_Ty_close_Ty_wrt_Ty :
forall Ty1 skA1,
  fv_ska_Ty (close_Ty_wrt_Ty skA1 Ty1) [=] remove skA1 (fv_ska_Ty Ty1).
Proof.
unfold close_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Ty_close_Ty_wrt_Ty : lngen.
#[export] Hint Rewrite fv_ska_Ty_close_Ty_wrt_Ty using solve [auto] : lngen.

Lemma fv_ska_Sch_close_Sch_wrt_Ty :
forall Sch1 skA1,
  fv_ska_Sch (close_Sch_wrt_Ty skA1 Sch1) [=] remove skA1 (fv_ska_Sch Sch1).
Proof.
unfold close_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Sch_close_Sch_wrt_Ty : lngen.
#[export] Hint Rewrite fv_ska_Sch_close_Sch_wrt_Ty using solve [auto] : lngen.

Lemma fv_e_x_e_close_e_wrt_e :
forall e1 x1,
  fv_e_x_e (close_e_wrt_e x1 e1) [=] remove x1 (fv_e_x_e e1).
Proof.
unfold close_e_wrt_e; default_simp.
Qed.

#[export] Hint Resolve fv_e_x_e_close_e_wrt_e : lngen.
#[export] Hint Rewrite fv_e_x_e_close_e_wrt_e using solve [auto] : lngen.

(* begin hide *)

Lemma fv_dska_DTy_open_DTy_wrt_DTy_rec_lower_mutual :
(forall DTy1 DTy2 n1,
  fv_dska_DTy DTy1 [<=] fv_dska_DTy (open_DTy_wrt_DTy_rec n1 DTy2 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_open_DTy_wrt_DTy_rec_lower :
forall DTy1 DTy2 n1,
  fv_dska_DTy DTy1 [<=] fv_dska_DTy (open_DTy_wrt_DTy_rec n1 DTy2 DTy1).
Proof.
pose proof fv_dska_DTy_open_DTy_wrt_DTy_rec_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_open_DTy_wrt_DTy_rec_lower : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_dska_DSch_open_DSch_wrt_DTy_rec_lower_mutual :
(forall DSch1 DTy1 n1,
  fv_dska_DSch DSch1 [<=] fv_dska_DSch (open_DSch_wrt_DTy_rec n1 DTy1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_open_DSch_wrt_DTy_rec_lower :
forall DSch1 DTy1 n1,
  fv_dska_DSch DSch1 [<=] fv_dska_DSch (open_DSch_wrt_DTy_rec n1 DTy1 DSch1).
Proof.
pose proof fv_dska_DSch_open_DSch_wrt_DTy_rec_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_open_DSch_wrt_DTy_rec_lower : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Ty_open_Ty_wrt_Ty_rec_lower_mutual :
(forall Ty1 Ty2 n1,
  fv_ska_Ty Ty1 [<=] fv_ska_Ty (open_Ty_wrt_Ty_rec n1 Ty2 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_open_Ty_wrt_Ty_rec_lower :
forall Ty1 Ty2 n1,
  fv_ska_Ty Ty1 [<=] fv_ska_Ty (open_Ty_wrt_Ty_rec n1 Ty2 Ty1).
Proof.
pose proof fv_ska_Ty_open_Ty_wrt_Ty_rec_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_open_Ty_wrt_Ty_rec_lower : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Sch_open_Sch_wrt_Ty_rec_lower_mutual :
(forall Sch1 Ty1 n1,
  fv_ska_Sch Sch1 [<=] fv_ska_Sch (open_Sch_wrt_Ty_rec n1 Ty1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_open_Sch_wrt_Ty_rec_lower :
forall Sch1 Ty1 n1,
  fv_ska_Sch Sch1 [<=] fv_ska_Sch (open_Sch_wrt_Ty_rec n1 Ty1 Sch1).
Proof.
pose proof fv_ska_Sch_open_Sch_wrt_Ty_rec_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_open_Sch_wrt_Ty_rec_lower : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_e_x_e_open_e_wrt_e_rec_lower_mutual :
(forall e1 e2 n1,
  fv_e_x_e e1 [<=] fv_e_x_e (open_e_wrt_e_rec n1 e2 e1)).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_open_e_wrt_e_rec_lower :
forall e1 e2 n1,
  fv_e_x_e e1 [<=] fv_e_x_e (open_e_wrt_e_rec n1 e2 e1).
Proof.
pose proof fv_e_x_e_open_e_wrt_e_rec_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_open_e_wrt_e_rec_lower : lngen.

(* end hide *)

Lemma fv_dska_DTy_open_DTy_wrt_DTy_lower :
forall DTy1 DTy2,
  fv_dska_DTy DTy1 [<=] fv_dska_DTy (open_DTy_wrt_DTy DTy1 DTy2).
Proof.
unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DTy_open_DTy_wrt_DTy_lower : lngen.

Lemma fv_dska_DSch_open_DSch_wrt_DTy_lower :
forall DSch1 DTy1,
  fv_dska_DSch DSch1 [<=] fv_dska_DSch (open_DSch_wrt_DTy DSch1 DTy1).
Proof.
unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DSch_open_DSch_wrt_DTy_lower : lngen.

Lemma fv_ska_Ty_open_Ty_wrt_Ty_lower :
forall Ty1 Ty2,
  fv_ska_Ty Ty1 [<=] fv_ska_Ty (open_Ty_wrt_Ty Ty1 Ty2).
Proof.
unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Ty_open_Ty_wrt_Ty_lower : lngen.

Lemma fv_ska_Sch_open_Sch_wrt_Ty_lower :
forall Sch1 Ty1,
  fv_ska_Sch Sch1 [<=] fv_ska_Sch (open_Sch_wrt_Ty Sch1 Ty1).
Proof.
unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Sch_open_Sch_wrt_Ty_lower : lngen.

Lemma fv_e_x_e_open_e_wrt_e_lower :
forall e1 e2,
  fv_e_x_e e1 [<=] fv_e_x_e (open_e_wrt_e e1 e2).
Proof.
unfold open_e_wrt_e; default_simp.
Qed.

#[export] Hint Resolve fv_e_x_e_open_e_wrt_e_lower : lngen.

(* begin hide *)

Lemma fv_dska_DTy_open_DTy_wrt_DTy_rec_upper_mutual :
(forall DTy1 DTy2 n1,
  fv_dska_DTy (open_DTy_wrt_DTy_rec n1 DTy2 DTy1) [<=] fv_dska_DTy DTy2 `union` fv_dska_DTy DTy1).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_open_DTy_wrt_DTy_rec_upper :
forall DTy1 DTy2 n1,
  fv_dska_DTy (open_DTy_wrt_DTy_rec n1 DTy2 DTy1) [<=] fv_dska_DTy DTy2 `union` fv_dska_DTy DTy1.
Proof.
pose proof fv_dska_DTy_open_DTy_wrt_DTy_rec_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_open_DTy_wrt_DTy_rec_upper : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_dska_DSch_open_DSch_wrt_DTy_rec_upper_mutual :
(forall DSch1 DTy1 n1,
  fv_dska_DSch (open_DSch_wrt_DTy_rec n1 DTy1 DSch1) [<=] fv_dska_DTy DTy1 `union` fv_dska_DSch DSch1).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_open_DSch_wrt_DTy_rec_upper :
forall DSch1 DTy1 n1,
  fv_dska_DSch (open_DSch_wrt_DTy_rec n1 DTy1 DSch1) [<=] fv_dska_DTy DTy1 `union` fv_dska_DSch DSch1.
Proof.
pose proof fv_dska_DSch_open_DSch_wrt_DTy_rec_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_open_DSch_wrt_DTy_rec_upper : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Ty_open_Ty_wrt_Ty_rec_upper_mutual :
(forall Ty1 Ty2 n1,
  fv_ska_Ty (open_Ty_wrt_Ty_rec n1 Ty2 Ty1) [<=] fv_ska_Ty Ty2 `union` fv_ska_Ty Ty1).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_open_Ty_wrt_Ty_rec_upper :
forall Ty1 Ty2 n1,
  fv_ska_Ty (open_Ty_wrt_Ty_rec n1 Ty2 Ty1) [<=] fv_ska_Ty Ty2 `union` fv_ska_Ty Ty1.
Proof.
pose proof fv_ska_Ty_open_Ty_wrt_Ty_rec_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_open_Ty_wrt_Ty_rec_upper : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_ska_Sch_open_Sch_wrt_Ty_rec_upper_mutual :
(forall Sch1 Ty1 n1,
  fv_ska_Sch (open_Sch_wrt_Ty_rec n1 Ty1 Sch1) [<=] fv_ska_Ty Ty1 `union` fv_ska_Sch Sch1).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_open_Sch_wrt_Ty_rec_upper :
forall Sch1 Ty1 n1,
  fv_ska_Sch (open_Sch_wrt_Ty_rec n1 Ty1 Sch1) [<=] fv_ska_Ty Ty1 `union` fv_ska_Sch Sch1.
Proof.
pose proof fv_ska_Sch_open_Sch_wrt_Ty_rec_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_open_Sch_wrt_Ty_rec_upper : lngen.

(* end hide *)

(* begin hide *)

Lemma fv_e_x_e_open_e_wrt_e_rec_upper_mutual :
(forall e1 e2 n1,
  fv_e_x_e (open_e_wrt_e_rec n1 e2 e1) [<=] fv_e_x_e e2 `union` fv_e_x_e e1).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_open_e_wrt_e_rec_upper :
forall e1 e2 n1,
  fv_e_x_e (open_e_wrt_e_rec n1 e2 e1) [<=] fv_e_x_e e2 `union` fv_e_x_e e1.
Proof.
pose proof fv_e_x_e_open_e_wrt_e_rec_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_open_e_wrt_e_rec_upper : lngen.

(* end hide *)

Lemma fv_dska_DTy_open_DTy_wrt_DTy_upper :
forall DTy1 DTy2,
  fv_dska_DTy (open_DTy_wrt_DTy DTy1 DTy2) [<=] fv_dska_DTy DTy2 `union` fv_dska_DTy DTy1.
Proof.
unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DTy_open_DTy_wrt_DTy_upper : lngen.

Lemma fv_dska_DSch_open_DSch_wrt_DTy_upper :
forall DSch1 DTy1,
  fv_dska_DSch (open_DSch_wrt_DTy DSch1 DTy1) [<=] fv_dska_DTy DTy1 `union` fv_dska_DSch DSch1.
Proof.
unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve fv_dska_DSch_open_DSch_wrt_DTy_upper : lngen.

Lemma fv_ska_Ty_open_Ty_wrt_Ty_upper :
forall Ty1 Ty2,
  fv_ska_Ty (open_Ty_wrt_Ty Ty1 Ty2) [<=] fv_ska_Ty Ty2 `union` fv_ska_Ty Ty1.
Proof.
unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Ty_open_Ty_wrt_Ty_upper : lngen.

Lemma fv_ska_Sch_open_Sch_wrt_Ty_upper :
forall Sch1 Ty1,
  fv_ska_Sch (open_Sch_wrt_Ty Sch1 Ty1) [<=] fv_ska_Ty Ty1 `union` fv_ska_Sch Sch1.
Proof.
unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve fv_ska_Sch_open_Sch_wrt_Ty_upper : lngen.

Lemma fv_e_x_e_open_e_wrt_e_upper :
forall e1 e2,
  fv_e_x_e (open_e_wrt_e e1 e2) [<=] fv_e_x_e e2 `union` fv_e_x_e e1.
Proof.
unfold open_e_wrt_e; default_simp.
Qed.

#[export] Hint Resolve fv_e_x_e_open_e_wrt_e_upper : lngen.

(* begin hide *)

Lemma fv_dska_DTy_subst_dska_DTy_fresh_mutual :
(forall DTy1 DTy2 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1) [=] fv_dska_DTy DTy1).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_subst_dska_DTy_fresh :
forall DTy1 DTy2 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1) [=] fv_dska_DTy DTy1.
Proof.
pose proof fv_dska_DTy_subst_dska_DTy_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_subst_dska_DTy_fresh : lngen.
#[export] Hint Rewrite fv_dska_DTy_subst_dska_DTy_fresh using solve [auto] : lngen.

(* begin hide *)

Lemma fv_dska_DSch_subst_dska_DSch_fresh_mutual :
(forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1) [=] fv_dska_DSch DSch1).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_subst_dska_DSch_fresh :
forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1) [=] fv_dska_DSch DSch1.
Proof.
pose proof fv_dska_DSch_subst_dska_DSch_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_subst_dska_DSch_fresh : lngen.
#[export] Hint Rewrite fv_dska_DSch_subst_dska_DSch_fresh using solve [auto] : lngen.

(* begin hide *)

Lemma fv_ska_Ty_subst_ska_Ty_fresh_mutual :
(forall Ty1 Ty2 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1) [=] fv_ska_Ty Ty1).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_subst_ska_Ty_fresh :
forall Ty1 Ty2 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1) [=] fv_ska_Ty Ty1.
Proof.
pose proof fv_ska_Ty_subst_ska_Ty_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_subst_ska_Ty_fresh : lngen.
#[export] Hint Rewrite fv_ska_Ty_subst_ska_Ty_fresh using solve [auto] : lngen.

(* begin hide *)

Lemma fv_ska_Sch_subst_ska_Sch_fresh_mutual :
(forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1) [=] fv_ska_Sch Sch1).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_subst_ska_Sch_fresh :
forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1) [=] fv_ska_Sch Sch1.
Proof.
pose proof fv_ska_Sch_subst_ska_Sch_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_subst_ska_Sch_fresh : lngen.
#[export] Hint Rewrite fv_ska_Sch_subst_ska_Sch_fresh using solve [auto] : lngen.

(* begin hide *)

Lemma fv_e_x_e_subst_tm_e_fresh_mutual :
(forall e1 e2 x1,
  x1 `notin` fv_e_x_e e1 ->
  fv_e_x_e (subst_tm_e e2 x1 e1) [=] fv_e_x_e e1).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_subst_tm_e_fresh :
forall e1 e2 x1,
  x1 `notin` fv_e_x_e e1 ->
  fv_e_x_e (subst_tm_e e2 x1 e1) [=] fv_e_x_e e1.
Proof.
pose proof fv_e_x_e_subst_tm_e_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_subst_tm_e_fresh : lngen.
#[export] Hint Rewrite fv_e_x_e_subst_tm_e_fresh using solve [auto] : lngen.

(* begin hide *)

Lemma fv_dska_DTy_subst_dska_DTy_lower_mutual :
(forall DTy1 DTy2 dskA1,
  remove dskA1 (fv_dska_DTy DTy1) [<=] fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_subst_dska_DTy_lower :
forall DTy1 DTy2 dskA1,
  remove dskA1 (fv_dska_DTy DTy1) [<=] fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1).
Proof.
pose proof fv_dska_DTy_subst_dska_DTy_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_subst_dska_DTy_lower : lngen.

(* begin hide *)

Lemma fv_dska_DSch_subst_dska_DSch_lower_mutual :
(forall DSch1 DTy1 dskA1,
  remove dskA1 (fv_dska_DSch DSch1) [<=] fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_subst_dska_DSch_lower :
forall DSch1 DTy1 dskA1,
  remove dskA1 (fv_dska_DSch DSch1) [<=] fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof fv_dska_DSch_subst_dska_DSch_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_subst_dska_DSch_lower : lngen.

(* begin hide *)

Lemma fv_ska_Ty_subst_ska_Ty_lower_mutual :
(forall Ty1 Ty2 skA1,
  remove skA1 (fv_ska_Ty Ty1) [<=] fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_subst_ska_Ty_lower :
forall Ty1 Ty2 skA1,
  remove skA1 (fv_ska_Ty Ty1) [<=] fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1).
Proof.
pose proof fv_ska_Ty_subst_ska_Ty_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_subst_ska_Ty_lower : lngen.

(* begin hide *)

Lemma fv_ska_Sch_subst_ska_Sch_lower_mutual :
(forall Sch1 Ty1 skA1,
  remove skA1 (fv_ska_Sch Sch1) [<=] fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_subst_ska_Sch_lower :
forall Sch1 Ty1 skA1,
  remove skA1 (fv_ska_Sch Sch1) [<=] fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof fv_ska_Sch_subst_ska_Sch_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_subst_ska_Sch_lower : lngen.

(* begin hide *)

Lemma fv_e_x_e_subst_tm_e_lower_mutual :
(forall e1 e2 x1,
  remove x1 (fv_e_x_e e1) [<=] fv_e_x_e (subst_tm_e e2 x1 e1)).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_subst_tm_e_lower :
forall e1 e2 x1,
  remove x1 (fv_e_x_e e1) [<=] fv_e_x_e (subst_tm_e e2 x1 e1).
Proof.
pose proof fv_e_x_e_subst_tm_e_lower_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_subst_tm_e_lower : lngen.

(* begin hide *)

Lemma fv_dska_DTy_subst_dska_DTy_notin_mutual :
(forall DTy1 DTy2 dskA1 dskA2,
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 `notin` fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_subst_dska_DTy_notin :
forall DTy1 DTy2 dskA1 dskA2,
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 `notin` fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1).
Proof.
pose proof fv_dska_DTy_subst_dska_DTy_notin_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_subst_dska_DTy_notin : lngen.

(* begin hide *)

Lemma fv_dska_DSch_subst_dska_DSch_notin_mutual :
(forall DSch1 DTy1 dskA1 dskA2,
  dskA2 `notin` fv_dska_DSch DSch1 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_subst_dska_DSch_notin :
forall DSch1 DTy1 dskA1 dskA2,
  dskA2 `notin` fv_dska_DSch DSch1 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof fv_dska_DSch_subst_dska_DSch_notin_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_subst_dska_DSch_notin : lngen.

(* begin hide *)

Lemma fv_ska_Ty_subst_ska_Ty_notin_mutual :
(forall Ty1 Ty2 skA1 skA2,
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 `notin` fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_subst_ska_Ty_notin :
forall Ty1 Ty2 skA1 skA2,
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 `notin` fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1).
Proof.
pose proof fv_ska_Ty_subst_ska_Ty_notin_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_subst_ska_Ty_notin : lngen.

(* begin hide *)

Lemma fv_ska_Sch_subst_ska_Sch_notin_mutual :
(forall Sch1 Ty1 skA1 skA2,
  skA2 `notin` fv_ska_Sch Sch1 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_subst_ska_Sch_notin :
forall Sch1 Ty1 skA1 skA2,
  skA2 `notin` fv_ska_Sch Sch1 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof fv_ska_Sch_subst_ska_Sch_notin_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_subst_ska_Sch_notin : lngen.

(* begin hide *)

Lemma fv_e_x_e_subst_tm_e_notin_mutual :
(forall e1 e2 x1 x2,
  x2 `notin` fv_e_x_e e1 ->
  x2 `notin` fv_e_x_e e2 ->
  x2 `notin` fv_e_x_e (subst_tm_e e2 x1 e1)).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_subst_tm_e_notin :
forall e1 e2 x1 x2,
  x2 `notin` fv_e_x_e e1 ->
  x2 `notin` fv_e_x_e e2 ->
  x2 `notin` fv_e_x_e (subst_tm_e e2 x1 e1).
Proof.
pose proof fv_e_x_e_subst_tm_e_notin_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_subst_tm_e_notin : lngen.

(* begin hide *)

Lemma fv_dska_DTy_subst_dska_DTy_upper_mutual :
(forall DTy1 DTy2 dskA1,
  fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1) [<=] fv_dska_DTy DTy2 `union` remove dskA1 (fv_dska_DTy DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DTy_subst_dska_DTy_upper :
forall DTy1 DTy2 dskA1,
  fv_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy1) [<=] fv_dska_DTy DTy2 `union` remove dskA1 (fv_dska_DTy DTy1).
Proof.
pose proof fv_dska_DTy_subst_dska_DTy_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DTy_subst_dska_DTy_upper : lngen.

(* begin hide *)

Lemma fv_dska_DSch_subst_dska_DSch_upper_mutual :
(forall DSch1 DTy1 dskA1,
  fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1) [<=] fv_dska_DTy DTy1 `union` remove dskA1 (fv_dska_DSch DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_dska_DSch_subst_dska_DSch_upper :
forall DSch1 DTy1 dskA1,
  fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1) [<=] fv_dska_DTy DTy1 `union` remove dskA1 (fv_dska_DSch DSch1).
Proof.
pose proof fv_dska_DSch_subst_dska_DSch_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_dska_DSch_subst_dska_DSch_upper : lngen.

(* begin hide *)

Lemma fv_ska_Ty_subst_ska_Ty_upper_mutual :
(forall Ty1 Ty2 skA1,
  fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1) [<=] fv_ska_Ty Ty2 `union` remove skA1 (fv_ska_Ty Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Ty_subst_ska_Ty_upper :
forall Ty1 Ty2 skA1,
  fv_ska_Ty (subst_ska_Ty Ty2 skA1 Ty1) [<=] fv_ska_Ty Ty2 `union` remove skA1 (fv_ska_Ty Ty1).
Proof.
pose proof fv_ska_Ty_subst_ska_Ty_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Ty_subst_ska_Ty_upper : lngen.

(* begin hide *)

Lemma fv_ska_Sch_subst_ska_Sch_upper_mutual :
(forall Sch1 Ty1 skA1,
  fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1) [<=] fv_ska_Ty Ty1 `union` remove skA1 (fv_ska_Sch Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_ska_Sch_subst_ska_Sch_upper :
forall Sch1 Ty1 skA1,
  fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1) [<=] fv_ska_Ty Ty1 `union` remove skA1 (fv_ska_Sch Sch1).
Proof.
pose proof fv_ska_Sch_subst_ska_Sch_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_ska_Sch_subst_ska_Sch_upper : lngen.

(* begin hide *)

Lemma fv_e_x_e_subst_tm_e_upper_mutual :
(forall e1 e2 x1,
  fv_e_x_e (subst_tm_e e2 x1 e1) [<=] fv_e_x_e e2 `union` remove x1 (fv_e_x_e e1)).
Proof.
apply_mutual_ind e_mutind;
default_simp; fsetdec.
Qed.
...
Lemma fv_e_x_e_subst_tm_e_upper :
forall e1 e2 x1,
  fv_e_x_e (subst_tm_e e2 x1 e1) [<=] fv_e_x_e e2 `union` remove x1 (fv_e_x_e e1).
Proof.
pose proof fv_e_x_e_subst_tm_e_upper_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve fv_e_x_e_subst_tm_e_upper : lngen.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy_rec_mutual :
(forall DTy2 DTy1 dskA1 dskA2 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (close_DTy_wrt_DTy_rec n1 dskA2 DTy2) = close_DTy_wrt_DTy_rec n1 dskA2 (subst_dska_DTy DTy1 dskA1 DTy2)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy_rec :
forall DTy2 DTy1 dskA1 dskA2 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (close_DTy_wrt_DTy_rec n1 dskA2 DTy2) = close_DTy_wrt_DTy_rec n1 dskA2 (subst_dska_DTy DTy1 dskA1 DTy2).
Proof.
pose proof subst_dska_DTy_close_DTy_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_close_DTy_wrt_DTy_rec : lngen.

(* begin hide *)

Lemma subst_dska_DSch_close_DSch_wrt_DTy_rec_mutual :
(forall DSch1 DTy1 dskA1 dskA2 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (close_DSch_wrt_DTy_rec n1 dskA2 DSch1) = close_DSch_wrt_DTy_rec n1 dskA2 (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_close_DSch_wrt_DTy_rec :
forall DSch1 DTy1 dskA1 dskA2 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (close_DSch_wrt_DTy_rec n1 dskA2 DSch1) = close_DSch_wrt_DTy_rec n1 dskA2 (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_close_DSch_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_close_DSch_wrt_DTy_rec : lngen.

(* begin hide *)

Lemma subst_ska_Ty_close_Ty_wrt_Ty_rec_mutual :
(forall Ty2 Ty1 skA1 skA2 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (close_Ty_wrt_Ty_rec n1 skA2 Ty2) = close_Ty_wrt_Ty_rec n1 skA2 (subst_ska_Ty Ty1 skA1 Ty2)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_close_Ty_wrt_Ty_rec :
forall Ty2 Ty1 skA1 skA2 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (close_Ty_wrt_Ty_rec n1 skA2 Ty2) = close_Ty_wrt_Ty_rec n1 skA2 (subst_ska_Ty Ty1 skA1 Ty2).
Proof.
pose proof subst_ska_Ty_close_Ty_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_close_Ty_wrt_Ty_rec : lngen.

(* begin hide *)

Lemma subst_ska_Sch_close_Sch_wrt_Ty_rec_mutual :
(forall Sch1 Ty1 skA1 skA2 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (close_Sch_wrt_Ty_rec n1 skA2 Sch1) = close_Sch_wrt_Ty_rec n1 skA2 (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_close_Sch_wrt_Ty_rec :
forall Sch1 Ty1 skA1 skA2 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (close_Sch_wrt_Ty_rec n1 skA2 Sch1) = close_Sch_wrt_Ty_rec n1 skA2 (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_close_Sch_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_close_Sch_wrt_Ty_rec : lngen.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy :
forall DTy2 DTy1 dskA1 dskA2,
  lc_DTy DTy1 ->  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (close_DTy_wrt_DTy dskA2 DTy2) = close_DTy_wrt_DTy dskA2 (subst_dska_DTy DTy1 dskA1 DTy2).
Proof.
unfold close_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_close_DTy_wrt_DTy : lngen.

Lemma subst_dska_DSch_close_DSch_wrt_DTy :
forall DSch1 DTy1 dskA1 dskA2,
  lc_DTy DTy1 ->  dskA1 <> dskA2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (close_DSch_wrt_DTy dskA2 DSch1) = close_DSch_wrt_DTy dskA2 (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
unfold close_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_close_DSch_wrt_DTy : lngen.

Lemma subst_ska_Ty_close_Ty_wrt_Ty :
forall Ty2 Ty1 skA1 skA2,
  lc_Ty Ty1 ->  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (close_Ty_wrt_Ty skA2 Ty2) = close_Ty_wrt_Ty skA2 (subst_ska_Ty Ty1 skA1 Ty2).
Proof.
unfold close_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_close_Ty_wrt_Ty : lngen.

Lemma subst_ska_Sch_close_Sch_wrt_Ty :
forall Sch1 Ty1 skA1 skA2,
  lc_Ty Ty1 ->  skA1 <> skA2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (close_Sch_wrt_Ty skA2 Sch1) = close_Sch_wrt_Ty skA2 (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
unfold close_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_close_Sch_wrt_Ty : lngen.
...
Lemma subst_dska_DTy_degree_DTy_wrt_DTy_mutual :
(forall DTy1 DTy2 dskA1 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  degree_DTy_wrt_DTy n1 DTy2 ->
  degree_DTy_wrt_DTy n1 (subst_dska_DTy DTy2 dskA1 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_degree_DTy_wrt_DTy :
forall DTy1 DTy2 dskA1 n1,
  degree_DTy_wrt_DTy n1 DTy1 ->
  degree_DTy_wrt_DTy n1 DTy2 ->
  degree_DTy_wrt_DTy n1 (subst_dska_DTy DTy2 dskA1 DTy1).
Proof.
pose proof subst_dska_DTy_degree_DTy_wrt_DTy_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_degree_DTy_wrt_DTy : lngen.

(* begin hide *)

Lemma subst_dska_DSch_degree_DSch_wrt_DTy_mutual :
(forall DSch1 DTy1 dskA1 n1,
  degree_DSch_wrt_DTy n1 DSch1 ->
  degree_DTy_wrt_DTy n1 DTy1 ->
  degree_DSch_wrt_DTy n1 (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_degree_DSch_wrt_DTy :
forall DSch1 DTy1 dskA1 n1,
  degree_DSch_wrt_DTy n1 DSch1 ->
  degree_DTy_wrt_DTy n1 DTy1 ->
  degree_DSch_wrt_DTy n1 (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_degree_DSch_wrt_DTy_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_degree_DSch_wrt_DTy : lngen.

(* begin hide *)

Lemma subst_ska_Ty_degree_Ty_wrt_Ty_mutual :
(forall Ty1 Ty2 skA1 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  degree_Ty_wrt_Ty n1 Ty2 ->
  degree_Ty_wrt_Ty n1 (subst_ska_Ty Ty2 skA1 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_degree_Ty_wrt_Ty :
forall Ty1 Ty2 skA1 n1,
  degree_Ty_wrt_Ty n1 Ty1 ->
  degree_Ty_wrt_Ty n1 Ty2 ->
  degree_Ty_wrt_Ty n1 (subst_ska_Ty Ty2 skA1 Ty1).
Proof.
pose proof subst_ska_Ty_degree_Ty_wrt_Ty_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_degree_Ty_wrt_Ty : lngen.

(* begin hide *)

Lemma subst_ska_Sch_degree_Sch_wrt_Ty_mutual :
(forall Sch1 Ty1 skA1 n1,
  degree_Sch_wrt_Ty n1 Sch1 ->
  degree_Ty_wrt_Ty n1 Ty1 ->
  degree_Sch_wrt_Ty n1 (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_degree_Sch_wrt_Ty :
forall Sch1 Ty1 skA1 n1,
  degree_Sch_wrt_Ty n1 Sch1 ->
  degree_Ty_wrt_Ty n1 Ty1 ->
  degree_Sch_wrt_Ty n1 (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_degree_Sch_wrt_Ty_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_degree_Sch_wrt_Ty : lngen.
...
Lemma subst_dska_DTy_fresh_eq_mutual :
(forall DTy2 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy2 ->
  subst_dska_DTy DTy1 dskA1 DTy2 = DTy2).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_fresh_eq :
forall DTy2 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy2 ->
  subst_dska_DTy DTy1 dskA1 DTy2 = DTy2.
Proof.
pose proof subst_dska_DTy_fresh_eq_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_fresh_eq : lngen.
#[export] Hint Rewrite subst_dska_DTy_fresh_eq using solve [auto] : lngen.

(* begin hide *)

Lemma subst_dska_DSch_fresh_eq_mutual :
(forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  subst_dska_DSch DTy1 dskA1 DSch1 = DSch1).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_fresh_eq :
forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  subst_dska_DSch DTy1 dskA1 DSch1 = DSch1.
Proof.
pose proof subst_dska_DSch_fresh_eq_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_fresh_eq : lngen.
#[export] Hint Rewrite subst_dska_DSch_fresh_eq using solve [auto] : lngen.

(* begin hide *)

Lemma subst_ska_Ty_fresh_eq_mutual :
(forall Ty2 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty2 ->
  subst_ska_Ty Ty1 skA1 Ty2 = Ty2).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_fresh_eq :
forall Ty2 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty2 ->
  subst_ska_Ty Ty1 skA1 Ty2 = Ty2.
Proof.
pose proof subst_ska_Ty_fresh_eq_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_fresh_eq : lngen.
#[export] Hint Rewrite subst_ska_Ty_fresh_eq using solve [auto] : lngen.

(* begin hide *)

Lemma subst_ska_Sch_fresh_eq_mutual :
(forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  subst_ska_Sch Ty1 skA1 Sch1 = Sch1).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_fresh_eq :
forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  subst_ska_Sch Ty1 skA1 Sch1 = Sch1.
Proof.
pose proof subst_ska_Sch_fresh_eq_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_fresh_eq : lngen.
#[export] Hint Rewrite subst_ska_Sch_fresh_eq using solve [auto] : lngen.
...
Lemma subst_dska_DTy_fresh_same_mutual :
(forall DTy2 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DTy (subst_dska_DTy DTy1 dskA1 DTy2)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_fresh_same :
forall DTy2 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DTy (subst_dska_DTy DTy1 dskA1 DTy2).
Proof.
pose proof subst_dska_DTy_fresh_same_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_fresh_same : lngen.

(* begin hide *)

Lemma subst_dska_DSch_fresh_same_mutual :
(forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_fresh_same :
forall DSch1 DTy1 dskA1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_fresh_same_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_fresh_same : lngen.

(* begin hide *)

Lemma subst_ska_Ty_fresh_same_mutual :
(forall Ty2 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Ty (subst_ska_Ty Ty1 skA1 Ty2)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_fresh_same :
forall Ty2 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Ty (subst_ska_Ty Ty1 skA1 Ty2).
Proof.
pose proof subst_ska_Ty_fresh_same_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_fresh_same : lngen.

(* begin hide *)

Lemma subst_ska_Sch_fresh_same_mutual :
(forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_fresh_same :
forall Sch1 Ty1 skA1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_fresh_same_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_fresh_same : lngen.
...
(forall e2 e1 x1,
  x1 `notin` fv_e_x_e e1 ->
  x1 `notin` fv_e_x_e (subst_tm_e e1 x1 e2)).
Proof.
apply_mutual_ind e_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_fresh_mutual :
(forall DTy2 DTy1 dskA1 dskA2,
  dskA1 `notin` fv_dska_DTy DTy2 ->
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DTy (subst_dska_DTy DTy1 dskA2 DTy2)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_fresh :
forall DTy2 DTy1 dskA1 dskA2,
  dskA1 `notin` fv_dska_DTy DTy2 ->
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DTy (subst_dska_DTy DTy1 dskA2 DTy2).
Proof.
pose proof subst_dska_DTy_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_fresh : lngen.

(* begin hide *)

Lemma subst_dska_DSch_fresh_mutual :
(forall DSch1 DTy1 dskA1 dskA2,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA2 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_fresh :
forall DSch1 DTy1 dskA1 dskA2,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  dskA1 `notin` fv_dska_DTy DTy1 ->
  dskA1 `notin` fv_dska_DSch (subst_dska_DSch DTy1 dskA2 DSch1).
Proof.
pose proof subst_dska_DSch_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_fresh : lngen.

(* begin hide *)

Lemma subst_ska_Ty_fresh_mutual :
(forall Ty2 Ty1 skA1 skA2,
  skA1 `notin` fv_ska_Ty Ty2 ->
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Ty (subst_ska_Ty Ty1 skA2 Ty2)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_fresh :
forall Ty2 Ty1 skA1 skA2,
  skA1 `notin` fv_ska_Ty Ty2 ->
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Ty (subst_ska_Ty Ty1 skA2 Ty2).
Proof.
pose proof subst_ska_Ty_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_fresh : lngen.

(* begin hide *)

Lemma subst_ska_Sch_fresh_mutual :
(forall Sch1 Ty1 skA1 skA2,
  skA1 `notin` fv_ska_Sch Sch1 ->
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA2 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_fresh :
forall Sch1 Ty1 skA1 skA2,
  skA1 `notin` fv_ska_Sch Sch1 ->
  skA1 `notin` fv_ska_Ty Ty1 ->
  skA1 `notin` fv_ska_Sch (subst_ska_Sch Ty1 skA2 Sch1).
Proof.
pose proof subst_ska_Sch_fresh_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_fresh : lngen.
...
(forall e2 e1 x1 x2,
  x1 `notin` fv_e_x_e e2 ->
  x1 `notin` fv_e_x_e e1 ->
  x1 `notin` fv_e_x_e (subst_tm_e e1 x2 e2)).
Proof.
apply_mutual_ind e_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_lc_DTy :
forall DTy1 DTy2 dskA1,
  lc_DTy DTy1 ->
  lc_DTy DTy2 ->
  lc_DTy (subst_dska_DTy DTy2 dskA1 DTy1).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_lc_DTy : lngen.

Lemma subst_dska_DSch_lc_DSch :
forall DSch1 DTy1 dskA1,
  lc_DSch DSch1 ->
  lc_DTy DTy1 ->
  lc_DSch (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_lc_DSch : lngen.

Lemma subst_ska_Ty_lc_Ty :
forall Ty1 Ty2 skA1,
  lc_Ty Ty1 ->
  lc_Ty Ty2 ->
  lc_Ty (subst_ska_Ty Ty2 skA1 Ty1).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_lc_Ty : lngen.

Lemma subst_ska_Sch_lc_Sch :
forall Sch1 Ty1 skA1,
  lc_Sch Sch1 ->
  lc_Ty Ty1 ->
  lc_Sch (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_lc_Sch : lngen.
...
Lemma subst_dska_DTy_open_DTy_wrt_DTy_rec_mutual :
(forall DTy3 DTy1 DTy2 dskA1 n1,
  lc_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy_rec n1 DTy2 DTy3) = open_DTy_wrt_DTy_rec n1 (subst_dska_DTy DTy1 dskA1 DTy2) (subst_dska_DTy DTy1 dskA1 DTy3)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_open_DTy_wrt_DTy_rec :
forall DTy3 DTy1 DTy2 dskA1 n1,
  lc_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy_rec n1 DTy2 DTy3) = open_DTy_wrt_DTy_rec n1 (subst_dska_DTy DTy1 dskA1 DTy2) (subst_dska_DTy DTy1 dskA1 DTy3).
Proof.
pose proof subst_dska_DTy_open_DTy_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_open_DTy_wrt_DTy_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_dska_DSch_open_DSch_wrt_DTy_rec_mutual :
(forall DSch1 DTy1 DTy2 dskA1 n1,
  lc_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 DTy2 DSch1) = open_DSch_wrt_DTy_rec n1 (subst_dska_DTy DTy1 dskA1 DTy2) (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_open_DSch_wrt_DTy_rec :
forall DSch1 DTy1 DTy2 dskA1 n1,
  lc_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 DTy2 DSch1) = open_DSch_wrt_DTy_rec n1 (subst_dska_DTy DTy1 dskA1 DTy2) (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_open_DSch_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_open_DSch_wrt_DTy_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Ty_open_Ty_wrt_Ty_rec_mutual :
(forall Ty3 Ty1 Ty2 skA1 n1,
  lc_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty_rec n1 Ty2 Ty3) = open_Ty_wrt_Ty_rec n1 (subst_ska_Ty Ty1 skA1 Ty2) (subst_ska_Ty Ty1 skA1 Ty3)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_open_Ty_wrt_Ty_rec :
forall Ty3 Ty1 Ty2 skA1 n1,
  lc_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty_rec n1 Ty2 Ty3) = open_Ty_wrt_Ty_rec n1 (subst_ska_Ty Ty1 skA1 Ty2) (subst_ska_Ty Ty1 skA1 Ty3).
Proof.
pose proof subst_ska_Ty_open_Ty_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_open_Ty_wrt_Ty_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Sch_open_Sch_wrt_Ty_rec_mutual :
(forall Sch1 Ty1 Ty2 skA1 n1,
  lc_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 Ty2 Sch1) = open_Sch_wrt_Ty_rec n1 (subst_ska_Ty Ty1 skA1 Ty2) (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_open_Sch_wrt_Ty_rec :
forall Sch1 Ty1 Ty2 skA1 n1,
  lc_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 Ty2 Sch1) = open_Sch_wrt_Ty_rec n1 (subst_ska_Ty Ty1 skA1 Ty2) (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_open_Sch_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_open_Sch_wrt_Ty_rec : lngen.
...
Lemma subst_dska_DTy_open_DTy_wrt_DTy :
forall DTy3 DTy1 DTy2 dskA1,
  lc_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy DTy3 DTy2) = open_DTy_wrt_DTy (subst_dska_DTy DTy1 dskA1 DTy3) (subst_dska_DTy DTy1 dskA1 DTy2).
Proof.
unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_open_DTy_wrt_DTy : lngen.

Lemma subst_dska_DSch_open_DSch_wrt_DTy :
forall DSch1 DTy1 DTy2 dskA1,
  lc_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy DSch1 DTy2) = open_DSch_wrt_DTy (subst_dska_DSch DTy1 dskA1 DSch1) (subst_dska_DTy DTy1 dskA1 DTy2).
Proof.
unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_open_DSch_wrt_DTy : lngen.

Lemma subst_ska_Ty_open_Ty_wrt_Ty :
forall Ty3 Ty1 Ty2 skA1,
  lc_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty Ty3 Ty2) = open_Ty_wrt_Ty (subst_ska_Ty Ty1 skA1 Ty3) (subst_ska_Ty Ty1 skA1 Ty2).
Proof.
unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_open_Ty_wrt_Ty : lngen.

Lemma subst_ska_Sch_open_Sch_wrt_Ty :
forall Sch1 Ty1 Ty2 skA1,
  lc_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty Sch1 Ty2) = open_Sch_wrt_Ty (subst_ska_Sch Ty1 skA1 Sch1) (subst_ska_Ty Ty1 skA1 Ty2).
Proof.
unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_open_Sch_wrt_Ty : lngen.
...
Lemma subst_dska_DTy_open_DTy_wrt_DTy_var :
forall DTy2 DTy1 dskA1 dskA2,
  dskA1 <> dskA2 ->
  lc_DTy DTy1 ->
  open_DTy_wrt_DTy (subst_dska_DTy DTy1 dskA1 DTy2) (DT_SkVar_f dskA2) = subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy DTy2 (DT_SkVar_f dskA2)).
Proof.
intros; rewrite subst_dska_DTy_open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_open_DTy_wrt_DTy_var : lngen.

Lemma subst_dska_DSch_open_DSch_wrt_DTy_var :
forall DSch1 DTy1 dskA1 dskA2,
  dskA1 <> dskA2 ->
  lc_DTy DTy1 ->
  open_DSch_wrt_DTy (subst_dska_DSch DTy1 dskA1 DSch1) (DT_SkVar_f dskA2) = subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy DSch1 (DT_SkVar_f dskA2)).
Proof.
intros; rewrite subst_dska_DSch_open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_open_DSch_wrt_DTy_var : lngen.

Lemma subst_ska_Ty_open_Ty_wrt_Ty_var :
forall Ty2 Ty1 skA1 skA2,
  skA1 <> skA2 ->
  lc_Ty Ty1 ->
  open_Ty_wrt_Ty (subst_ska_Ty Ty1 skA1 Ty2) (T_SkVar_f skA2) = subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty Ty2 (T_SkVar_f skA2)).
Proof.
intros; rewrite subst_ska_Ty_open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_open_Ty_wrt_Ty_var : lngen.

Lemma subst_ska_Sch_open_Sch_wrt_Ty_var :
forall Sch1 Ty1 skA1 skA2,
  skA1 <> skA2 ->
  lc_Ty Ty1 ->
  open_Sch_wrt_Ty (subst_ska_Sch Ty1 skA1 Sch1) (T_SkVar_f skA2) = subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty Sch1 (T_SkVar_f skA2)).
Proof.
intros; rewrite subst_ska_Sch_open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_open_Sch_wrt_Ty_var : lngen.
...
Lemma subst_dska_DTy_spec_rec_mutual :
(forall DTy1 DTy2 dskA1 n1,
  subst_dska_DTy DTy2 dskA1 DTy1 = open_DTy_wrt_DTy_rec n1 DTy2 (close_DTy_wrt_DTy_rec n1 dskA1 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_spec_rec :
forall DTy1 DTy2 dskA1 n1,
  subst_dska_DTy DTy2 dskA1 DTy1 = open_DTy_wrt_DTy_rec n1 DTy2 (close_DTy_wrt_DTy_rec n1 dskA1 DTy1).
Proof.
pose proof subst_dska_DTy_spec_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_spec_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_dska_DSch_spec_rec_mutual :
(forall DSch1 DTy1 dskA1 n1,
  subst_dska_DSch DTy1 dskA1 DSch1 = open_DSch_wrt_DTy_rec n1 DTy1 (close_DSch_wrt_DTy_rec n1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_spec_rec :
forall DSch1 DTy1 dskA1 n1,
  subst_dska_DSch DTy1 dskA1 DSch1 = open_DSch_wrt_DTy_rec n1 DTy1 (close_DSch_wrt_DTy_rec n1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_spec_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_spec_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Ty_spec_rec_mutual :
(forall Ty1 Ty2 skA1 n1,
  subst_ska_Ty Ty2 skA1 Ty1 = open_Ty_wrt_Ty_rec n1 Ty2 (close_Ty_wrt_Ty_rec n1 skA1 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_spec_rec :
forall Ty1 Ty2 skA1 n1,
  subst_ska_Ty Ty2 skA1 Ty1 = open_Ty_wrt_Ty_rec n1 Ty2 (close_Ty_wrt_Ty_rec n1 skA1 Ty1).
Proof.
pose proof subst_ska_Ty_spec_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_spec_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Sch_spec_rec_mutual :
(forall Sch1 Ty1 skA1 n1,
  subst_ska_Sch Ty1 skA1 Sch1 = open_Sch_wrt_Ty_rec n1 Ty1 (close_Sch_wrt_Ty_rec n1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_spec_rec :
forall Sch1 Ty1 skA1 n1,
  subst_ska_Sch Ty1 skA1 Sch1 = open_Sch_wrt_Ty_rec n1 Ty1 (close_Sch_wrt_Ty_rec n1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_spec_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_spec_rec : lngen.
...
Lemma subst_dska_DTy_spec :
forall DTy1 DTy2 dskA1,
  subst_dska_DTy DTy2 dskA1 DTy1 = open_DTy_wrt_DTy (close_DTy_wrt_DTy dskA1 DTy1) DTy2.
Proof.
unfold close_DTy_wrt_DTy; unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_spec : lngen.

Lemma subst_dska_DSch_spec :
forall DSch1 DTy1 dskA1,
  subst_dska_DSch DTy1 dskA1 DSch1 = open_DSch_wrt_DTy (close_DSch_wrt_DTy dskA1 DSch1) DTy1.
Proof.
unfold close_DSch_wrt_DTy; unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_spec : lngen.

Lemma subst_ska_Ty_spec :
forall Ty1 Ty2 skA1,
  subst_ska_Ty Ty2 skA1 Ty1 = open_Ty_wrt_Ty (close_Ty_wrt_Ty skA1 Ty1) Ty2.
Proof.
unfold close_Ty_wrt_Ty; unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_spec : lngen.

Lemma subst_ska_Sch_spec :
forall Sch1 Ty1 skA1,
  subst_ska_Sch Ty1 skA1 Sch1 = open_Sch_wrt_Ty (close_Sch_wrt_Ty skA1 Sch1) Ty1.
Proof.
unfold close_Sch_wrt_Ty; unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_spec : lngen.
...
Lemma subst_dska_DTy_subst_dska_DTy_mutual :
(forall DTy1 DTy2 DTy3 dskA2 dskA1,
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 <> dskA1 ->
  subst_dska_DTy DTy2 dskA1 (subst_dska_DTy DTy3 dskA2 DTy1) = subst_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy3) dskA2 (subst_dska_DTy DTy2 dskA1 DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_subst_dska_DTy :
forall DTy1 DTy2 DTy3 dskA2 dskA1,
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 <> dskA1 ->
  subst_dska_DTy DTy2 dskA1 (subst_dska_DTy DTy3 dskA2 DTy1) = subst_dska_DTy (subst_dska_DTy DTy2 dskA1 DTy3) dskA2 (subst_dska_DTy DTy2 dskA1 DTy1).
Proof.
pose proof subst_dska_DTy_subst_dska_DTy_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_subst_dska_DTy : lngen.

(* begin hide *)

Lemma subst_dska_DSch_subst_dska_DSch_mutual :
(forall DSch1 DTy1 DTy2 dskA2 dskA1,
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  subst_dska_DSch DTy1 dskA1 (subst_dska_DSch DTy2 dskA2 DSch1) = subst_dska_DSch (subst_dska_DTy DTy1 dskA1 DTy2) dskA2 (subst_dska_DSch DTy1 dskA1 DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_subst_dska_DSch :
forall DSch1 DTy1 DTy2 dskA2 dskA1,
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  subst_dska_DSch DTy1 dskA1 (subst_dska_DSch DTy2 dskA2 DSch1) = subst_dska_DSch (subst_dska_DTy DTy1 dskA1 DTy2) dskA2 (subst_dska_DSch DTy1 dskA1 DSch1).
Proof.
pose proof subst_dska_DSch_subst_dska_DSch_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_subst_dska_DSch : lngen.

(* begin hide *)

Lemma subst_ska_Ty_subst_ska_Ty_mutual :
(forall Ty1 Ty2 Ty3 skA2 skA1,
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 <> skA1 ->
  subst_ska_Ty Ty2 skA1 (subst_ska_Ty Ty3 skA2 Ty1) = subst_ska_Ty (subst_ska_Ty Ty2 skA1 Ty3) skA2 (subst_ska_Ty Ty2 skA1 Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_subst_ska_Ty :
forall Ty1 Ty2 Ty3 skA2 skA1,
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 <> skA1 ->
  subst_ska_Ty Ty2 skA1 (subst_ska_Ty Ty3 skA2 Ty1) = subst_ska_Ty (subst_ska_Ty Ty2 skA1 Ty3) skA2 (subst_ska_Ty Ty2 skA1 Ty1).
Proof.
pose proof subst_ska_Ty_subst_ska_Ty_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_subst_ska_Ty : lngen.

(* begin hide *)

Lemma subst_ska_Sch_subst_ska_Sch_mutual :
(forall Sch1 Ty1 Ty2 skA2 skA1,
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  subst_ska_Sch Ty1 skA1 (subst_ska_Sch Ty2 skA2 Sch1) = subst_ska_Sch (subst_ska_Ty Ty1 skA1 Ty2) skA2 (subst_ska_Sch Ty1 skA1 Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_subst_ska_Sch :
forall Sch1 Ty1 Ty2 skA2 skA1,
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  subst_ska_Sch Ty1 skA1 (subst_ska_Sch Ty2 skA2 Sch1) = subst_ska_Sch (subst_ska_Ty Ty1 skA1 Ty2) skA2 (subst_ska_Sch Ty1 skA1 Sch1).
Proof.
pose proof subst_ska_Sch_subst_ska_Sch_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_subst_ska_Sch : lngen.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy_rec_open_DTy_wrt_DTy_rec_mutual :
(forall DTy2 DTy1 dskA1 dskA2 n1,
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  degree_DTy_wrt_DTy n1 DTy1 ->
  subst_dska_DTy DTy1 dskA1 DTy2 = close_DTy_wrt_DTy_rec n1 dskA2 (subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy_rec n1 (DT_SkVar_f dskA2) DTy2))).
Proof.
apply_mutual_ind DTy_mutrec;
default_simp.
Qed.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy_rec_open_DTy_wrt_DTy_rec :
forall DTy2 DTy1 dskA1 dskA2 n1,
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  ...
  subst_dska_DTy DTy1 dskA1 DTy2 = close_DTy_wrt_DTy_rec n1 dskA2 (subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy_rec n1 (DT_SkVar_f dskA2) DTy2)).
Proof.
pose proof subst_dska_DTy_close_DTy_wrt_DTy_rec_open_DTy_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_close_DTy_wrt_DTy_rec_open_DTy_wrt_DTy_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_dska_DSch_close_DSch_wrt_DTy_rec_open_DSch_wrt_DTy_rec_mutual :
(forall DSch1 DTy1 dskA1 dskA2 n1,
  dskA2 `notin` fv_dska_DSch DSch1 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  degree_DTy_wrt_DTy n1 DTy1 ->
  subst_dska_DSch DTy1 dskA1 DSch1 = close_DSch_wrt_DTy_rec n1 dskA2 (subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 (DT_SkVar_f dskA2) DSch1))).
Proof.
apply_mutual_ind DSch_mutrec;
default_simp.
Qed.
...
Lemma subst_dska_DSch_close_DSch_wrt_DTy_rec_open_DSch_wrt_DTy_rec :
forall DSch1 DTy1 dskA1 dskA2 n1,
  dskA2 `notin` fv_dska_DSch DSch1 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  ...
  subst_dska_DSch DTy1 dskA1 DSch1 = close_DSch_wrt_DTy_rec n1 dskA2 (subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 (DT_SkVar_f dskA2) DSch1)).
Proof.
pose proof subst_dska_DSch_close_DSch_wrt_DTy_rec_open_DSch_wrt_DTy_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_close_DSch_wrt_DTy_rec_open_DSch_wrt_DTy_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Ty_close_Ty_wrt_Ty_rec_open_Ty_wrt_Ty_rec_mutual :
(forall Ty2 Ty1 skA1 skA2 n1,
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  degree_Ty_wrt_Ty n1 Ty1 ->
  subst_ska_Ty Ty1 skA1 Ty2 = close_Ty_wrt_Ty_rec n1 skA2 (subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty_rec n1 (T_SkVar_f skA2) Ty2))).
Proof.
apply_mutual_ind Ty_mutrec;
default_simp.
Qed.
...
Lemma subst_ska_Ty_close_Ty_wrt_Ty_rec_open_Ty_wrt_Ty_rec :
forall Ty2 Ty1 skA1 skA2 n1,
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  ...
  subst_ska_Ty Ty1 skA1 Ty2 = close_Ty_wrt_Ty_rec n1 skA2 (subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty_rec n1 (T_SkVar_f skA2) Ty2)).
Proof.
pose proof subst_ska_Ty_close_Ty_wrt_Ty_rec_open_Ty_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_close_Ty_wrt_Ty_rec_open_Ty_wrt_Ty_rec : lngen.

(* end hide *)

(* begin hide *)

Lemma subst_ska_Sch_close_Sch_wrt_Ty_rec_open_Sch_wrt_Ty_rec_mutual :
(forall Sch1 Ty1 skA1 skA2 n1,
  skA2 `notin` fv_ska_Sch Sch1 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  degree_Ty_wrt_Ty n1 Ty1 ->
  subst_ska_Sch Ty1 skA1 Sch1 = close_Sch_wrt_Ty_rec n1 skA2 (subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 (T_SkVar_f skA2) Sch1))).
Proof.
apply_mutual_ind Sch_mutrec;
default_simp.
Qed.
...
Lemma subst_ska_Sch_close_Sch_wrt_Ty_rec_open_Sch_wrt_Ty_rec :
forall Sch1 Ty1 skA1 skA2 n1,
  skA2 `notin` fv_ska_Sch Sch1 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  ...
  subst_ska_Sch Ty1 skA1 Sch1 = close_Sch_wrt_Ty_rec n1 skA2 (subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 (T_SkVar_f skA2) Sch1)).
Proof.
pose proof subst_ska_Sch_close_Sch_wrt_Ty_rec_open_Sch_wrt_Ty_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_close_Sch_wrt_Ty_rec_open_Sch_wrt_Ty_rec : lngen.
...
Lemma subst_dska_DTy_close_DTy_wrt_DTy_open_DTy_wrt_DTy :
forall DTy2 DTy1 dskA1 dskA2,
  dskA2 `notin` fv_dska_DTy DTy2 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  lc_DTy DTy1 ->
  subst_dska_DTy DTy1 dskA1 DTy2 = close_DTy_wrt_DTy dskA2 (subst_dska_DTy DTy1 dskA1 (open_DTy_wrt_DTy DTy2 (DT_SkVar_f dskA2))).
Proof.
unfold close_DTy_wrt_DTy; unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_close_DTy_wrt_DTy_open_DTy_wrt_DTy : lngen.

Lemma subst_dska_DSch_close_DSch_wrt_DTy_open_DSch_wrt_DTy :
forall DSch1 DTy1 dskA1 dskA2,
  dskA2 `notin` fv_dska_DSch DSch1 ->
  dskA2 `notin` fv_dska_DTy DTy1 ->
  dskA2 <> dskA1 ->
  lc_DTy DTy1 ->
  subst_dska_DSch DTy1 dskA1 DSch1 = close_DSch_wrt_DTy dskA2 (subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy DSch1 (DT_SkVar_f dskA2))).
Proof.
unfold close_DSch_wrt_DTy; unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_close_DSch_wrt_DTy_open_DSch_wrt_DTy : lngen.

Lemma subst_ska_Ty_close_Ty_wrt_Ty_open_Ty_wrt_Ty :
forall Ty2 Ty1 skA1 skA2,
  skA2 `notin` fv_ska_Ty Ty2 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  lc_Ty Ty1 ->
  subst_ska_Ty Ty1 skA1 Ty2 = close_Ty_wrt_Ty skA2 (subst_ska_Ty Ty1 skA1 (open_Ty_wrt_Ty Ty2 (T_SkVar_f skA2))).
Proof.
unfold close_Ty_wrt_Ty; unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_close_Ty_wrt_Ty_open_Ty_wrt_Ty : lngen.

Lemma subst_ska_Sch_close_Sch_wrt_Ty_open_Sch_wrt_Ty :
forall Sch1 Ty1 skA1 skA2,
  skA2 `notin` fv_ska_Sch Sch1 ->
  skA2 `notin` fv_ska_Ty Ty1 ->
  skA2 <> skA1 ->
  lc_Ty Ty1 ->
  subst_ska_Sch Ty1 skA1 Sch1 = close_Sch_wrt_Ty skA2 (subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty Sch1 (T_SkVar_f skA2))).
Proof.
unfold close_Sch_wrt_Ty; unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_close_Sch_wrt_Ty_open_Sch_wrt_Ty : lngen.
...
Lemma subst_dska_DSch_DS_Forall :
forall dskA2 DSch1 DTy1 dskA1,
  lc_DTy DTy1 ->
  dskA2 `notin` fv_dska_DTy DTy1 `union` fv_dska_DSch DSch1 `union` singleton dskA1 ->
  subst_dska_DSch DTy1 dskA1 (DS_Forall DSch1) = DS_Forall (close_DSch_wrt_DTy dskA2 (subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy DSch1 (DT_SkVar_f dskA2)))).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_DS_Forall : lngen.

Lemma subst_ska_Sch_S_Forall :
forall skA2 Sch1 Ty1 skA1,
  lc_Ty Ty1 ->
  skA2 `notin` fv_ska_Ty Ty1 `union` fv_ska_Sch Sch1 `union` singleton skA1 ->
  subst_ska_Sch Ty1 skA1 (S_Forall Sch1) = S_Forall (close_Sch_wrt_Ty skA2 (subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty Sch1 (T_SkVar_f skA2)))).
Proof.
default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_S_Forall : lngen.

Lemma subst_tm_e_e_Lam :
forall x2 e2 e1 x1,
  lc_e e1 ->
  x2 `notin` fv_e_x_e e1 `union` fv_e_x_e e2 `union` singleton x1 ->
...
forall x2 e2 e3 e1 x1,
  lc_e e1 ->
  x2 `notin` fv_e_x_e e1 `union` fv_e_x_e e3 `union` singleton x1 ->
...
Lemma subst_dska_DTy_intro_rec_mutual :
(forall DTy1 dskA1 DTy2 n1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  open_DTy_wrt_DTy_rec n1 DTy2 DTy1 = subst_dska_DTy DTy2 dskA1 (open_DTy_wrt_DTy_rec n1 (DT_SkVar_f dskA1) DTy1)).
Proof.
apply_mutual_ind DTy_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DTy_intro_rec :
forall DTy1 dskA1 DTy2 n1,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  open_DTy_wrt_DTy_rec n1 DTy2 DTy1 = subst_dska_DTy DTy2 dskA1 (open_DTy_wrt_DTy_rec n1 (DT_SkVar_f dskA1) DTy1).
Proof.
pose proof subst_dska_DTy_intro_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DTy_intro_rec : lngen.
#[export] Hint Rewrite subst_dska_DTy_intro_rec using solve [auto] : lngen.

(* begin hide *)

Lemma subst_dska_DSch_intro_rec_mutual :
(forall DSch1 dskA1 DTy1 n1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  open_DSch_wrt_DTy_rec n1 DTy1 DSch1 = subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 (DT_SkVar_f dskA1) DSch1)).
Proof.
apply_mutual_ind DSch_mutind;
default_simp.
Qed.
...
Lemma subst_dska_DSch_intro_rec :
forall DSch1 dskA1 DTy1 n1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  open_DSch_wrt_DTy_rec n1 DTy1 DSch1 = subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy_rec n1 (DT_SkVar_f dskA1) DSch1).
Proof.
pose proof subst_dska_DSch_intro_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_dska_DSch_intro_rec : lngen.
#[export] Hint Rewrite subst_dska_DSch_intro_rec using solve [auto] : lngen.

(* begin hide *)

Lemma subst_ska_Ty_intro_rec_mutual :
(forall Ty1 skA1 Ty2 n1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  open_Ty_wrt_Ty_rec n1 Ty2 Ty1 = subst_ska_Ty Ty2 skA1 (open_Ty_wrt_Ty_rec n1 (T_SkVar_f skA1) Ty1)).
Proof.
apply_mutual_ind Ty_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Ty_intro_rec :
forall Ty1 skA1 Ty2 n1,
  skA1 `notin` fv_ska_Ty Ty1 ->
  open_Ty_wrt_Ty_rec n1 Ty2 Ty1 = subst_ska_Ty Ty2 skA1 (open_Ty_wrt_Ty_rec n1 (T_SkVar_f skA1) Ty1).
Proof.
pose proof subst_ska_Ty_intro_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Ty_intro_rec : lngen.
#[export] Hint Rewrite subst_ska_Ty_intro_rec using solve [auto] : lngen.

(* begin hide *)

Lemma subst_ska_Sch_intro_rec_mutual :
(forall Sch1 skA1 Ty1 n1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  open_Sch_wrt_Ty_rec n1 Ty1 Sch1 = subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 (T_SkVar_f skA1) Sch1)).
Proof.
apply_mutual_ind Sch_mutind;
default_simp.
Qed.
...
Lemma subst_ska_Sch_intro_rec :
forall Sch1 skA1 Ty1 n1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  open_Sch_wrt_Ty_rec n1 Ty1 Sch1 = subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty_rec n1 (T_SkVar_f skA1) Sch1).
Proof.
pose proof subst_ska_Sch_intro_rec_mutual as H; intuition eauto.
Qed.

#[export] Hint Resolve subst_ska_Sch_intro_rec : lngen.
#[export] Hint Rewrite subst_ska_Sch_intro_rec using solve [auto] : lngen.
...
Lemma subst_dska_DTy_intro :
forall dskA1 DTy1 DTy2,
  dskA1 `notin` fv_dska_DTy DTy1 ->
  open_DTy_wrt_DTy DTy1 DTy2 = subst_dska_DTy DTy2 dskA1 (open_DTy_wrt_DTy DTy1 (DT_SkVar_f dskA1)).
Proof.
unfold open_DTy_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DTy_intro : lngen.

Lemma subst_dska_DSch_intro :
forall dskA1 DSch1 DTy1,
  dskA1 `notin` fv_dska_DSch DSch1 ->
  open_DSch_wrt_DTy DSch1 DTy1 = subst_dska_DSch DTy1 dskA1 (open_DSch_wrt_DTy DSch1 (DT_SkVar_f dskA1)).
Proof.
unfold open_DSch_wrt_DTy; default_simp.
Qed.

#[export] Hint Resolve subst_dska_DSch_intro : lngen.

Lemma subst_ska_Ty_intro :
forall skA1 Ty1 Ty2,
  skA1 `notin` fv_ska_Ty Ty1 ->
  open_Ty_wrt_Ty Ty1 Ty2 = subst_ska_Ty Ty2 skA1 (open_Ty_wrt_Ty Ty1 (T_SkVar_f skA1)).
Proof.
unfold open_Ty_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Ty_intro : lngen.

Lemma subst_ska_Sch_intro :
forall skA1 Sch1 Ty1,
  skA1 `notin` fv_ska_Sch Sch1 ->
  open_Sch_wrt_Ty Sch1 Ty1 = subst_ska_Sch Ty1 skA1 (open_Sch_wrt_Ty Sch1 (T_SkVar_f skA1)).
Proof.
unfold open_Sch_wrt_Ty; default_simp.
Qed.

#[export] Hint Resolve subst_ska_Sch_intro : lngen.
